    ...
    >
      ...
      {isMinimized && !isExpanded && (
        <button
          ...
          className={`group flex items-center gap-2 px-4 py-3 rounded-2xl shadow-lg transition-all duration-300 hover:scale-105 ${
            isPlaying
              ? 'bg-gradient-to-r from-green-500 to-tribe-sage-600 text-white'
      ...
      {!isMinimized && !isExpanded && isPlaying && selectedPlaylistData && (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden w-72">
          {/* Header */}
          <div className="px-3 py-2 bg-gradient-to-r from-green-500 to-tribe-sage-600 flex items-center justify-between">
          ...
          <div className="p-4">
            {!isConnected ? (
              <div className="text-center">
                ...
                <button
                  onClick={connect}
                  className="w-full px-4 py-2 bg-gradient-to-r from-green-500 to-tribe-sage-600 text-white font-medium rounded-lg hover:from-green-600 hover:to-emerald-700 transition-colors"
                >
                  Connect Spotify
                </button>
              </div>
              ...
              <div>
                ...
                <button
                  onClick={() => setIsExpanded(true)}
                  className="w-full mt-2 text-xs text-tribe-sage-600 dark:text-tribe-sage-400 hover:underline"
                >
                  See all playlists →
                </button>
              </div>
      ...
      {isExpanded && (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden w-80">
          <div className="px-4 py-3 bg-gradient-to-r from-green-500 to-tribe-sage-600 flex items-center justify-between">
            <div className="flex items-center gap-2">
          ...
          <div className="p-4 max-h-80 overflow-y-auto">
            {!isConnected ? (
              <div className="text-center py-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-green-400 to-tribe-sage-600 flex items-center justify-center mx-auto mb-4">
                ...
                <button
                  onClick={connect}
                  className="px-6 py-2.5 bg-gradient-to-r from-green-500 to-tribe-sage-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-full shadow-lg shadow-green-500/25 transition-all"
                >
                  Connect Spotify
                </button>
              </div>
