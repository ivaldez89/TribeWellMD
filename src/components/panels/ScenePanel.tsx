...
export function ScenePanel({ isOpen, onClose }: ScenePanelProps) {
  ...
  return (
    ...
    >
      {/* Header - TribeWell branding matching other panels */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-gradient-to-r from-sand-50 to-blue-50 dark:from-sand-950/30 dark:to-blue-950/30">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/50 dark:to-purple-900/50 flex items-center justify-center">
          ...
          <div>
            <h2 className="text-sm font-bold text-secondary">TribeWell Scene</h2>
            <p className="text-[10px] text-content-muted">Study environment backgrounds</p>
          </div>
        </div>
        <button
          onClick={onClose}
