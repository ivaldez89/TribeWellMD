...
export function LandingFooter() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-40 h-12 bg-landing-header text-white shadow-lg">
      <div className="h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-1">
            <a href="https://facebook.com/tribewellmd" target="_blank" rel="noopener noreferrer" className="w-6 h-6 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors text-white/70 hover:text-white" aria-label="Facebook">
