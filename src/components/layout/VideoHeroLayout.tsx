...
// Force full-bleed on pages using this layout
function useFullBleed() {
  useLayoutEffect(() => {
    ...
    body.style.cssText = 'margin:0;padding:0;width:100%;height:100%;overflow:hidden;background:#000;';
...
// Minimal header for video hero pages
function VideoHeroHeader() {
...
// Minimal footer for video hero pages
function VideoHeroFooter() {
...
export function VideoHeroLayout({ children }: VideoHeroLayoutProps) {
  useFullBleed();
