    ...
    <section className="bg-surface py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-content mb-6">
            Built Different
          </h2>
          <p className="text-xl text-content-muted max-w-3xl mx-auto">
            Not another app to add to the pile. A single place where studying makes you stronger, and rest makes you sharper.
          </p>
        </div>
