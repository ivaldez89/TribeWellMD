  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8 space-y-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
            />
          </div>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                  selectedCategory === category
                    ...
                    : 'bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-teal-500 dark:hover:border-teal-500'
                }`}
              >
                {category}
              </button>
              ...
              >
                ...
                >
                  <div className="flex-1 pr-4">
                    <span className="text-xs font-medium text-teal-600 dark:text-teal-400 uppercase tracking-wide block mb-1">
                      {faq.category}
                    </span>
        ...
        {/* Still Need Help */}
        <div className="mt-12 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl p-8 text-white text-center">
