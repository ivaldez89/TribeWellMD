...
export default function PartnersPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-rose-600 via-pink-600 to-orange-500 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="max-w-4xl">
              ...
              <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="text-yellow-300">Real-World Impact</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  ...
                  className="px-8 py-4 bg-white text-rose-600 font-bold rounded-xl hover:bg-rose-50 transition-all shadow-lg"
                >
                  Become a Partner
                </a>
                <Link
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-700">
                      ...
                      <th className="px-6 py-4 text-left text-sm font-semibold text-rose-600 dark:text-rose-400">Donation Value</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-rose-600 dark:text-rose-400 font-medium">$0.001</td>
                    </tr>
                    <tr className="bg-white dark:bg-slate-800/50">
                      ...
                      <td className="px-6 py-4 text-sm text-rose-600 dark:text-rose-400 font-medium">$0.002-0.004</td>
                    </tr>
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-rose-600 dark:text-rose-400 font-medium">$0.005</td>
                    </tr>
                    <tr className="bg-white dark:bg-slate-800/50">
                      ...
                      <td className="px-6 py-4 text-sm text-rose-600 dark:text-rose-400 font-medium">$0.002</td>
                    </tr>
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-rose-600 dark:text-rose-400 font-medium">$0.01</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-gradient-to-r from-rose-500 to-pink-500 rounded-2xl p-6 md:p-8 text-white">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div>
                  ...
                  <p className="text-rose-100">active students</p>
                </div>
                <div>
                  <div className="text-3xl font-bold mb-1">50,000</div>
                  <p className="text-rose-100">points/week</p>
                </div>
                <div>
                  <div className="text-3xl font-bold mb-1">$50/week</div>
                  <p className="text-rose-100">to charity pool</p>
                </div>
                <div>
                  <div className="text-3xl font-bold mb-1">$2,600/year</div>
                  <p className="text-rose-100">per 1K students</p>
                </div>
              </div>
        ...
        <section ref={verificationRef} className="bg-gradient-to-b from-slate-100 to-slate-50 dark:from-slate-800/50 dark:to-slate-900 py-16 md:py-24">
          <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-700 ${verificationVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              {/* Tier 3 */}
              <div className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-2xl border-2 border-amber-300 dark:border-amber-700 shadow-lg">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                    <div className="w-10 h-10 rounded-lg bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center text-rose-600 dark:text-rose-400 flex-shrink-0">
