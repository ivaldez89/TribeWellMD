      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 space-y-8">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">3. Educational Disclaimer</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">5. Acceptable Use</h2>
              <p className="text-slate-600 dark:text-slate-300 mb-3">
                You agree NOT to:
              </p>
              <ul className="space-y-2 text-slate-600 dark:text-slate-300">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">6. User Content</h2>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">7. AI-Generated Content</h2>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">10. Changes to Terms</h2>
              <p className="text-slate-600 dark:text-slate-300">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4">11. Termination</h2>
              <p className="text-slate-600 dark:text-slate-300">
